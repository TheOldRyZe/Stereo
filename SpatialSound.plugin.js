...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"SpatialSound","authors":[{"name":"rug","discord_id":"840347082430873611"}],"version":"0.1.3","description":"This requires a capable stereo microphone."},"changelog":[{"title":"Changes","items":["Fixed"]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Enable Notifications","note":"Disable certain Voice & Video settings.","value":true}]};
  ...
  return class StereoSound extends Plugin {
    onStart() {
      ...
      thisObj.conn.setTransportOptions = function (obj) {
        ...
        if (obj.encodingVoiceBitRate < 1024000 ) { //186
                obj.encodingVoiceBitRate = 1024000
        }
    ...
    settingsWarning() {
      ...
      if (
        ...
        if (this.settings.enableToasts) {
          Toasts.show(
            "Please disable echo cancellation, noise reduction, and noise suppression for SpatialSound.",
